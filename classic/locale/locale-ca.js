...
Ext.define('Ext.locale.ca.picker.Date', {
	...
	monthYearText:
		'Seleccioni un mes (Control+Fletxa a Dalt o Abaix per canviar els anys)',
...
Ext.define('Ext.locale.ca.form.field.Date', {
	...
	invalidText:
		'{0} no &#233;s una data v&#224;lida - ha de tenir el format {1}',
	format: 'd/m/Y',
	altFormats: 'd/m/Y|d-m-y|d-m-Y|d/m|d-m|dm|dmy|dmY|d|Y-m-d',
});
Ext.define(
	'Ext.locale.ca.form.field.ComboBox',
...
Ext.define('Ext.locale.ca.form.field.VTypes', {
	...
	emailText:
		'Aquest camp ha de ser una adre&#231;a de e-mail amb el format "user@example.com"',
	urlText:
		'Aquest camp ha de ser una URL amb el format "http:/' +
		'/www.example.com"',
	alphaText: 'Aquest camp nom&#233;s pot contenir lletres i _',
	alphanumText: 'Aquest camp nom&#233;s por contenir lletres, nombres i _',
});
Ext.define(
	'Ext.locale.ca.form.field.HtmlEditor',
	{
