...
Ext.define(
	'Ext.locale.he.form.field.ComboBox',
...
Ext.define('Ext.locale.he.form.field.VTypes', {
	...
	emailText:
		'"user@example.com" שדה זה צריך להיות כתובת דואר אלקטרוני בפורמט',
	urlText:
		'"http:/' + '/www.example.com" שדה זה צריך להיות כתובת אינטרנט בפורמט',
	alphaText: '_שדה זה יכול להכיל רק אותיות ו',
	alphanumText: '_שדה זה יכול להכיל רק אותיות, מספרים ו',
});
Ext.define(
	'Ext.locale.he.form.field.HtmlEditor',
	{
