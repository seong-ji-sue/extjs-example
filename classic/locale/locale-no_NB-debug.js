...
Ext.define(
	'Ext.locale.no_NB.form.field.ComboBox',
	{
...
Ext.define('Ext.locale.no.form.field.VTypes', {
	...
	emailText:
		'Dette feltet skal være en epost adresse på formatet "bruker@domene.no"',
	urlText:
		'Dette feltet skal være en link (URL) på formatet "http:/' +
		'/www.domene.no"',
...
Ext.define(
	'Ext.locale.no_NB.form.field.HtmlEditor',
	{
