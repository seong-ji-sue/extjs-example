Ext.onReady(function () {
	...
	if (Ext.util && Ext.util.Format) {
		...
		Ext.util.Format.number = function (b, a) {
			return Ext.util.Format.__number(b, a || '0.000,00/i');
		};
...
Ext.define('Ext.locale.de.picker.Date', {
	...
	monthYearText:
		'Monat auswählen (Strg/Control + Hoch/Runter, um ein Jahr auszuwählen)',
...
Ext.define('Ext.locale.de.form.field.Date', {
	...
	invalidText:
		'{0} ist kein gültiges Datum - es muss im Format {1} eingegeben werden',
	format: 'd.m.Y',
	altFormats:
		'j.n.Y|j.n.y|j.n.|j.|j/n/Y|j/n/y|j-n-y|j-n-Y|j/n|j-n|dm|dmy|dmY|j|Y-n-j|Y-m-d',
	startDay: 1,
});
Ext.define(
...
Ext.define('Ext.locale.de.form.field.VTypes', {
	...
	emailText:
		'Dieses Feld sollte eine E-Mail-Adresse enthalten. Format: "user@example.com"',
	urlText:
		'Dieses Feld sollte eine URL enthalten. Format: "http:/' +
		'/www.example.com"',
