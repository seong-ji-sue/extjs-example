...
Ext.define('Ext.locale.pt_BR.form.field.Date', {
	...
	invalidText:
		'{0} não é uma data válida - deve ser informado no formato {1}',
	format: 'd/m/Y',
});
Ext.define(
...
Ext.define('Ext.locale.pt_BR.form.field.VTypes', {
	...
	emailText:
		'Este campo deve ser um endereço de e-mail válido, no formato "usuario@dominio.com.br"',
	urlText:
		'Este campo deve ser uma URL no formato "http:/' +
		'/www.dominio.com.br"',
...
Ext.define('Ext.locale.pt_BR.picker.Date', {
	...
	monthYearText:
		'Escolha um Mês (Control+Cima/Baixo para mover entre os anos)',
	todayTip: '{0} (Espaço)',
	format: 'd/m/Y',
	startDay: 0,
});
