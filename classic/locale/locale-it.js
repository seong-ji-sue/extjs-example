...
Ext.define(
	'Ext.locale.it.form.field.ComboBox',
...
Ext.define(
	'Ext.locale.it.form.field.HtmlEditor',
	{
...
Ext.define('Ext.locale.it.form.field.VTypes', {
	...
	emailText:
		'Il campo deve essere un indirizzo e-mail nel formato "nome@esempio.it"',
	urlText:
...
Ext.define('Ext.locale.it.grid.feature.Grouping', {
	...
	collapseTip:
		'Clicca per ridurre. Con il tasto CTRL espande tutti gli altri',
});
