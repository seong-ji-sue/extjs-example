...
Ext.define('Ext.locale.es.data.validator.Presence', {
	...
	getMessage: function () {
		var a = this;
		return a.message || a.config.message;
	},
});
...
Ext.define('Ext.locale.es.form.field.VTypes', {
	...
	emailText:
		'Este campo debe ser una dirección de correo electrónico con el formato "usuario@dominio.com"',
	urlText:
		'Este campo debe ser una URL con el formato "http:/' +
		'/www.dominio.com"',
