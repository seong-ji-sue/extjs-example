...
Ext.define('Ext.locale.cs.form.field.Date', {
	...
	invalidText:
		'{0} není platným datem - zkontrolujte zda-li je ve formátu {1}',
	format: 'd.m.Y',
	altFormats: 'd/m/Y|d-m-y|d-m-Y|d/m|d-m|dm|dmy|dmY|d|Y-m-d',
});
Ext.define(
	'Ext.locale.cs.form.field.ComboBox',
...
Ext.define('Ext.locale.cs.form.field.VTypes', {
	...
	emailText:
		'V tomto poli může být vyplněna pouze emailová adresa ve formátu "uživatel@doména.cz"',
	urlText:
		'V tomto poli může být vyplněna pouze URL (adresa internetové stránky) ve formátu "http:/' +
		'/www.doména.cz"',
	alphaText: 'Toto pole může obsahovat pouze písmena abecedy a znak _',
	alphanumText:
		'Toto pole může obsahovat pouze písmena abecedy, čísla a znak _',
});
Ext.define(
	'Ext.locale.cs.form.field.HtmlEditor',
	{
