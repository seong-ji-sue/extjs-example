...
Ext.define('Ext.locale.da.form.field.Date', {
	...
	invalidText:
		'{0} er ikke en tilladt dato - datoer skal angives i formatet {1}',
	format: 'd/m/y',
	altFormats: 'd/m/Y|d-m-y|d-m-Y|d/m|d-m|dm|dmy|dmY|d|Y-m-d',
});
Ext.define(
	'Ext.locale.da.form.field.ComboBox',
...
Ext.define('Ext.locale.da.form.field.VTypes', {
	...
	alphanumText:
		'Dette felt kan kun indeholde bogstaver, tal og "_" (understregning)',
});
Ext.define(
	'Ext.locale.da.form.field.HtmlEditor',
	{ override: 'Ext.form.field.HtmlEditor', createLinkText: 'Indtast URL:' },
	function () {
