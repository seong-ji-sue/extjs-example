				...
				function (require, module, exports) {
					...
					Fashion.apply(
						...
						_defineProperty(
							_Fashion$apply,
							'Types',
							require('./src/export/type/Types.js'),
						),
						_defineProperty(
							_Fashion$apply,
							'TypeVisitor',
							require('./src/export/type/TypeVisitor.js'),
						),
						_defineProperty(
							_Fashion$apply,
							'Output',
							require('./src/export/Output.js'),
						),
						_defineProperty(
							_Fashion$apply,
							'Runtime',
							require('./src/export/Runtime.js'),
						),
						_Fashion$apply),
					);
			...
			3: [
				function (require, module, exports) {
					...
					function trace(message, source) {
						if (debugging.trace) {
							console.log(
								createMessage('[DBG] ' + message, source),
							);
						}
					}
					...
					function mixin(target, bases) {
						...
						for (var b = 0; b < bases.length; b++) {
							...
							getAllKeys(baseProto, Base.prototype).forEach(
								function (name) {
						...
						_createClass(Output, [
							...
							},
							{
								...
								value: function unindent() {
									this.indentation = this.indentation.substr(
										this.indentstr.length,
									);
								},
							},
							{
						...
						function Runtime(config) {
							...
							me.registered = {
								...
								sliceArgs: function sliceArgs(
									...
									return this.getRuntime().sliceArgs(
										args,
										start,
										end,
									).items;
						...
						_createClass(Runtime, [
							...
							},
							{
								...
								value: function reset() {
									...
									this._currentCallStackScope =
										this.createCallStackScope();
							...
							},
							{
								...
								value: function createPrefixedFunctionBody(
									code,
								) {
									code =
										this.createTypesBlock() +
							...
							},
							{
								...
								value: function createWrappedFn(code) {
									return new Function(
										...
										'__udf',
										'__dyn',
										this.createPrefixedFunctionBody(code),
									);
								},
							},
							{
									...
									this.fn = function (rt, overrides, dyn) {
										...
										if (overrides) {
											if (overrides.$isScope) {
												runtime._globalScope =
													overrides;
											} else {
												runtime._globalScope.map =
													overrides;
											}
										}
							...
							},
							{
								...
								value: function register(methods) {
									if (methods['dynamic']) {
										Fashion.error(
											'Cannot register javascript function named "dynamic"',
										);
										delete methods['dynamic'];
									}
									if (methods['require']) {
										Fashion.error(
											'Cannot register javascript function named "require"',
										);
							...
							},
							{
								...
								value: function popCallStackScope() {
									this._currentCallStackScope =
										this._currentCallStackScope.resetScope;
							...
							},
							{
								...
								value: function pushSourceInfo(info) {
									if (this._currentCallStackScope) {
										this._currentCallStackScope.sourceInfo =
											info;
									}
									return true;
								},
							...
							},
							{
								...
								value: function getDefault(val) {
									...
									if (val.$isFashionNull) {
										if (
											this.constructor.allowNullDefaults
										) {
											return val;
										}
										return undefined;
								...
								value: function applySpreadArgs(args, name) {
									...
									if (proc) {
										...
										if (defaults) {
											...
											defaults =
												proc.functionDeclarations[name];
										}
									...
									var misisngParams =
										this.context &&
										this.context.missingParameters;
						...
						_createClass(CssVariableManager, [
							...
							},
							{
								...
								value: function calculate(vars) {
									...
									scope = new rt.Scope();
									for (name in vars) {
										key = Fashion.getJsName(
											name.replace(me.nameRe, ''),
										);
										if (key.indexOf('$') !== 0) {
											key = '$' + key;
										}
						...
						_createClass(Parser, [
							...
							},
							{
								...
								value: function parseValue(token) {
									...
									if (
										(match = rx.shortHexColor.exec(token))
									) {
							...
							[
								...
								},
								{
									...
									value: function adjust(
										...
										hsl.s = Color.constrainPercentage(
											hsl.s,
										);
										hsl.l = Color.constrainPercentage(
											hsl.l,
										);
					...
					var ColorHSLA = (function (_Color) {
						...
						function ColorHSLA(h, s, l, a) {
							...
							var _this5 = _possibleConstructorReturn(
								...
								(
									ColorHSLA.__proto__ ||
									Object.getPrototypeOf(ColorHSLA)
								).call(this),
							);
							...
							[
								...
								},
								{
									...
									value: function adjustLightness(percent) {
										this.l = Color.constrainPercentage(
											this.l + percent,
										);
										return this;
									},
					...
					var ColorRGBA = (function (_Color2) {
						...
						function ColorRGBA(r, g, b, a) {
							...
							var _this6 = _possibleConstructorReturn(
								...
								(
									ColorRGBA.__proto__ ||
									Object.getPrototypeOf(ColorRGBA)
								).call(this),
							);
						...
						_createClass(
							...
							[
								...
								},
								{
									...
									value: function getCompressedValue(
										lowerVal,
									) {
										var name =
										...
										if (name) {
											lowerVal =
												lowerVal.length > name.length
													? name
													: lowerVal;
										}

										if (
											ColorRGBA.useShortValues &&
											shortName
										) {
											lowerVal =
												lowerVal.length >
							...
							[
								...
								},
								{
									...
									value: function fromHSLA(color) {
										...
										var r = Color.constrainChannel(
												hue(h + 1 / 3) * 0xff,
											),
											g = Color.constrainChannel(
												hue(h) * 0xff,
											),
											b = Color.constrainChannel(
												hue(h - 1 / 3) * 0xff,
											);
					...
					var ColorStop = (function (_Type3) {
						...
						function ColorStop(color, stop) {
							...
							var _this7 = _possibleConstructorReturn(
								...
								(
									ColorStop.__proto__ ||
									Object.getPrototypeOf(ColorStop)
								).call(this),
							);
					...
					var FunctionCall = (function (_Type4) {
						...
						function FunctionCall(name, args) {
							...
							var _this8 = _possibleConstructorReturn(
								this,
								(
									FunctionCall.__proto__ ||
									Object.getPrototypeOf(FunctionCall)
								).call(this),
							);
					...
					var LinearGradient = (function (_Type5) {
						...
						function LinearGradient(position, stops) {
							...
							var _this9 = _possibleConstructorReturn(
								this,
								(
									LinearGradient.__proto__ ||
									Object.getPrototypeOf(LinearGradient)
								).call(this),
							);
						...
						_createClass(LinearGradient, [
							...
							},
							{
								...
								value: function operate(operation, right) {
									...
									return _get(
										LinearGradient.prototype.__proto__ ||
											Object.getPrototypeOf(
												LinearGradient.prototype,
											),
										'operate',
										this,
									).call(this, operation, right);
								},
							},
							{
								key: 'supports',
							...
							},
							{
								...
								value: function toOriginalWebkitString() {
									...
									for (i = 0; i < ln; i++) {
										args.push(
											stops[i].toOriginalWebkitString(),
										);
									}
						...
						_createClass(List, [
							...
							},
							{
								...
								value: function list(right) {
									var equals =
										this.separator == right.separator &&
										this.items.length == right.items.length;

									for (
										var i = 0;
										equals && i < this.items.length;
										++i
									) {
										equals = this.items[i].operate(
											'==',
											right.items[i],
										);
									}
							...
							[
								...
								},
								{
									...
									value: function insert(str, startVal) {
										...
										inserted =
											inserted.substring(0, start) +
											str.value +
											inserted.substring(start);
										return new Literal(
											Literal.deEscape(inserted),
										);
									},
								},
								{
					...
					var FashionNull = (function (_Literal) {
						...
						function FashionNull(value) {
							...
							return _possibleConstructorReturn(
								this,
								(
									FashionNull.__proto__ ||
									Object.getPrototypeOf(FashionNull)
								).call(this, value || null),
							);
						}
					...
					var Map = (function (_List) {
						...
						function Map(pairs) {
							...
							var _this13 = _possibleConstructorReturn(
								this,
								(
									Map.__proto__ || Object.getPrototypeOf(Map)
								).call(this, pairs),
							);
							...
							[
								...
								},
								{
									...
									value: function getUnitStr() {
										this.normalizeUnits();
										var unitStr =
											this.numeratorUnits.join('*');
										if (this.denominatorUnits.length) {
											unitStr +=
												'/' +
												this.denominatorUnits.join('*');
										}
										return unitStr;
									},
								},
								...
								},
								{
									...
									value: function _(right) {
										return new Numeric(
											Math.pow(this.value, right.value),
											this.unit || right.unit,
										);
									},
								},
								...
								},
								{
									...
									value: function normalizeUnits() {
										...
										if (!this.unitless()) {
											var clean = this.removeCommonUnits(
													this.numeratorUnits,
													this.denominatorUnits,
												),
												converted;
											...
											clean.num = Fashion.filter(
												clean.num,
												function (val) {
													return !!val;
												},
											);
											clean.den = Fashion.filter(
												clean.den,
												function (val) {
													return !!val;
												},
											...
											case '*':
												return {
													num: left.numeratorUnits
														.slice()
														.concat(
															right.numeratorUnits,
														),
													den: left.denominatorUnits
														.slice()
														.concat(
															right.denominatorUnits,
														),
												};
											case '/':
												return {
								...
								{
									key: 'coercionFactor',
									value: function coercionFactor(
										units,
										otherUnits,
									) {
										var res = this.removeCommonUnits(
												units,
												otherUnits,
											),
											fromUnits = res.num,
								...
								},
								{
									...
									value: function conversionFactor(
										fromUnit,
										toUnit,
									) {
								...
								},
								{
									...
									value: function removeCommonUnits(
										numUnits,
										denUnits,
									) {
										var map = {},
					...
					var ParentheticalExpression = (function (_Type9) {
						...
						function ParentheticalExpression(value) {
							...
							var _this15 = _possibleConstructorReturn(
								this,
								(
									ParentheticalExpression.__proto__ ||
									Object.getPrototypeOf(
					...
					var RadialGradient = (function (_Type10) {
						...
						function RadialGradient(position, shape, stops) {
							...
							var _this16 = _possibleConstructorReturn(
								this,
								(
									RadialGradient.__proto__ ||
									Object.getPrototypeOf(RadialGradient)
								).call(this),
							);
					...
					var SourceBuilder = (function (_TypeVisitor) {
						...
						function SourceBuilder(cfg) {
							...
							var _this17 = _possibleConstructorReturn(
								this,
								(
									SourceBuilder.__proto__ ||
									Object.getPrototypeOf(SourceBuilder)
								).call(this, cfg),
							);
							...
							[
								{
									...
									value: function list(obj) {
										...
										for (var i = 0; i < items.length; i++) {
											if (
												items[i] &&
												!items[i].$isFashionNull
											) {
												this.visit(items[i]);
												delta =
													output.output.length - len;
												if (!delta && sepLen && i > 0) {
													output.output = prev;
												}
												prev = output.output;
					...
					module.exports = {
						unboxType: function unboxType(expression) {
							...
							if (val && val.$isFashionType && val.$canUnbox) {
								val = val.value;
								if (
									expression.$isFashionString ||
									expression.$isFashionLiteral
								) {
				...
				function (require, module, exports) {
					...
					var Text = (function (_Literal2) {
						...
						function Text(value, quoteChar) {
							...
							var _this18 = _possibleConstructorReturn(
								this,
								(
									Text.__proto__ ||
					...
					var Type = (function () {
						...
						_createClass(Type, [
							...
							},
							{
								...
								value: function performOperation(
									operation,
									right,
								) {
									...
									// eg, ==.color or +.list
									var method =
										this[operation + '.' + right.type] ||
										this[operation];

									if (!method) {
										Fashion.raise(
											'Failed to find method for operation ' +
												operation +
												' on type ' +
												right.type +
												' with value ' +
	...
	Fashion.css.register(
		function (__rt) {
			__rt.register({
				...
				lighten: function (color, amount) {
					...
					if (amount.type !== 'number') {
						Fashion.raise(
							amount + " is not a number for 'lighten'",
						);
					}
					if (
						amount.value !== Color.constrainPercentage(amount.value)
					) {
						Fashion.raise(
							'Amount ' +
								amount +
								" must be between 0% and 100% for 'lighten'",
						);
					}
				...
				darken: function (color, amount) {
					...
					if (
						...
						Fashion.raise(
							'Amount ' +
								amount +
								" must be between 0% and 100% for 'darken'",
						);
					}
				...
				rgba: function (red, green, blue, alpha, color) {
					...
					if (!green || !green.$isFashionNumber) {
						...
						Fashion.raise(
							green + " is not a number for 'rgba' green",
						);
					}
					if (!blue || !blue.$isFashionNumber) {
						...
						Fashion.raise(
							blue + " is not a number for 'rgba' blue",
						);
					}
					if (!alpha || !alpha.$isFashionNumber) {
						...
						Fashion.raise(
							alpha + " is not a number for 'rgba' alpha",
						);
					}

					if (red.unit == '%') {
						red = new Numeric(
							(Color.constrainPercentage(red.value) / 100) * 255,
						);
					} else if (
						red.value !== Color.constrainChannel(red.value)
					) {
						Fashion.raise(
							'Color value ' +
								red +
								" must be between 0 and 255 inclusive for 'rgba'",
						);
					}

					if (green.unit == '%') {
						green = new Numeric(
							(Color.constrainPercentage(green.value) / 100) *
								255,
						);
					} else if (
						green.value !== Color.constrainChannel(green.value)
					) {
						Fashion.raise(
							'Color value ' +
								green +
					...
					if (blue.unit == '%') {
						blue = new Numeric(
							(Color.constrainPercentage(blue.value) / 100) * 255,
						);
					} else if (
						blue.value !== Color.constrainChannel(blue.value)
					) {
						Fashion.raise(
							'Color value ' +
								blue +
					...
					if (alpha.unit == '%') {
						alpha = new Numeric(
							Color.constrainPercentage(alpha.value) / 100,
						);
					} else if (
						alpha.value !== Color.constrainAlpha(alpha.value)
					) {
						Fashion.raise(
							'Alpha channel ' +
								alpha +
								" must be between 0 and 1 inclusive for 'rgba'",
						);
					}
				...
				mix: function (color_1, color_2, weight) {
					...
					weight =
						weight !== undefined ? weight : new Numeric(50, '%');

					if (color_1.type !== 'hsla' && color_1.type !== 'rgba') {
						Fashion.raise(
							'arg 1 ' + color_1 + " is not a color for 'mix'",
						);
					}
					if (color_2.type !== 'hsla' && color_2.type !== 'rgba') {
						Fashion.raise(
							'arg 2 ' + color_2 + " is not a color for 'mix'",
						);
					}
					if (weight.type !== 'number') {
						Fashion.raise(
							'arg 3 ' + weight + " is not a number for 'mix'",
						);
					}
					if (
						weight.value !== Color.constrainPercentage(weight.value)
					) {
						Fashion.raise(
							'Weight ' +
								weight +
								" must be between 0% and 100% for 'mix'",
						);
					}
			...
			var __rt_constructor = __rt.constructor.bind(__rt),
				...
				__rt_createPrefixedFunctionBody =
					__rt.createPrefixedFunctionBody.bind(__rt),
				...
				__rt_getRegisteredFunctions =
					__rt.getRegisteredFunctions.bind(__rt),
				...
				__rt_createCallStackScope =
					__rt.createCallStackScope.bind(__rt),
				...
				__rt_propertyIsEnumerable =
					__rt.propertyIsEnumerable.bind(__rt),
				__rt_constructor = __rt.constructor.bind(__rt),
			...
			Fashion.apply(__rt.functions, {
				material_color: function ($color_name, $color_variant) {
					__rt_createScope(
						__rt_functions.material_color &&
							__rt_functions.material_color.createdScope,
					);
					var $color_name = $color_name || __Null;
					__rt_set(__strings.$, $color_name, true);
					var $color_variant =
						$color_variant || new __Text('500', "'");
					__rt_set(__strings.a, $color_variant, true);
					__rt_set(
						__strings.A,
						__rt_box(
							__rt_registered.map_get.apply(
								__rt.registered,
								__rt_applySpreadArgs([
							...
							__rt_warn(
								__rt_unbox(
									__rt.operate(
										...
										new __Text(
											' combination did not match any of the material design colors.',
											'"',
										),
									),
								),
						...
						__rt_warn(
							__rt_unbox(
								__rt.operate(
									...
									new __Text(
										' did not match any of the material design colors.',
										'"',
									),
								),
							),
				...
				material_foreground_color: function ($color_name) {
					__rt_createScope(
						__rt_functions.material_foreground_color &&
							__rt_functions.material_foreground_color
								.createdScope,
					);
					var $color_name = $color_name || __Null;
		...
		function (__rt) {
			...
			__rt_setDynamic(
				'$dark-mode',
				__rt_getGlobalDefault('$dark_mode') || __False,
				0,
			);
			__rt_setDynamic(
				'$base_color_name',
				__rt_getGlobalDefault('$base_color_name') ||
					new __Text('blue', "'"),
				1,
			);
			__rt_setDynamic(
				'$material-colors',
				__rt_getGlobalDefault('$material_colors') ||
					new __Map([
						new __Text('red', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#ffebee'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#ffcdd2'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#ef9a9a'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#e57373'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ef5350'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#f44336'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#e53935'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#d32f2f'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#c62828'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#b71c1c'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ff8a80'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ff5252'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#ff1744'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#d50000'),
						]),
						new __Text('pink', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#fce4ec'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#f8bbd0'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#f48fb1'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#f06292'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ec407a'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#e91e63'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#d81b60'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#c2185b'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#ad1457'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#880e4f'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ff80ab'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ff4081'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#f50057'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#c51162'),
						]),
						new __Text('purple', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#f3e5f5'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#e1bee7'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#ce93d8'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#ba68c8'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ab47bc'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#9c27b0'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#8e24aa'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#7b1fa2'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#6a1b9a'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#4a148c'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ea80fc'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#e040fb'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#d500f9'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#aa00ff'),
						]),
						new __Text('deep-purple', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#ede7f6'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#d1c4e9'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#b39ddb'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#9575cd'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#7e57c2'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#673ab7'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#5e35b1'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#512da8'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#4527a0'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#311b92'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#b388ff'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#7c4dff'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#651fff'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#6200ea'),
						]),
						new __Text('indigo', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e8eaf6'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#c5cae9'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#9fa8da'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#7986cb'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#5c6bc0'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#3f51b5'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#3949ab'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#303f9f'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#283593'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#1a237e'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#8c9eff'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#536dfe'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#3d5afe'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#304ffe'),
						]),
						new __Text('blue', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e3f2fd'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#bbdefb'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#90caf9'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#64b5f6'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#42a5f5'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#2196f3'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#1e88e5'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#1976d2'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#1565c0'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#0d47a1'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#82b1ff'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#448aff'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#2979ff'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#2962ff'),
						]),
						new __Text('light-blue', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e1f5fe'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#b3e5fc'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#81d4fa'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#4fc3f7'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#29b6f6'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#03a9f4'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#039be5'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#0288d1'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#0277bd'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#01579b'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#80d8ff'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#40c4ff'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#00b0ff'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#0091ea'),
						]),
						new __Text('cyan', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e0f7fa'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#b2ebf2'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#80deea'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#4dd0e1'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#26c6da'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#00bcd4'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#00acc1'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#0097a7'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#00838f'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#006064'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#84ffff'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#18ffff'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#00e5ff'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#00b8d4'),
						]),
						new __Text('teal', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e0f2f1'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#b2dfdb'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#80cbc4'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#4db6ac'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#26a69a'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#009688'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#00897b'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#00796b'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#00695c'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#004d40'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#a7ffeb'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#64ffda'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#1de9b6'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#00bfa5'),
						]),
						new __Text('green', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#e8f5e9'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#c8e6c9'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#a5d6a7'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#81c784'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#66bb6a'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#4caf50'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#43a047'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#388e3c'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#2e7d32'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#1b5e20'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#b9f6ca'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#69f0ae'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#00e676'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#00c853'),
						]),
						new __Text('light-green', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#f1f8e9'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#dcedc8'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#c5e1a5'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#aed581'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#9ccc65'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#8bc34a'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#7cb342'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#689f38'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#558b2f'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#33691e'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ccff90'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#b2ff59'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#76ff03'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#64dd17'),
						]),
						new __Text('lime', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#f9fbe7'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#f0f4c3'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#e6ee9c'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#dce775'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#d4e157'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#cddc39'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#c0ca33'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#afb42b'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#9e9d24'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#827717'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#f4ff81'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#eeff41'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#c6ff00'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#aeea00'),
						]),
						new __Text('yellow', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#fffde7'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#fff9c4'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#fff59d'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#fff176'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ffee58'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#ffeb3b'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#fdd835'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#fbc02d'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#f9a825'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#f57f17'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ffff8d'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ffff00'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#ffea00'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#ffd600'),
						]),
						new __Text('amber', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#fff8e1'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#ffecb3'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#ffe082'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#ffd54f'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ffca28'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#ffc107'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#ffb300'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#ffa000'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#ff8f00'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#ff6f00'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ffe57f'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ffd740'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#ffc400'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#ffab00'),
						]),
						new __Text('orange', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#fff3e0'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#ffe0b2'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#ffcc80'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#ffb74d'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ffa726'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#ff9800'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#fb8c00'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#f57c00'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#ef6c00'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#e65100'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ffd180'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ffab40'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#ff9100'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#ff6d00'),
						]),
						new __Text('deep-orange', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#fbe9e7'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#ffccbc'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#ffab91'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#ff8a65'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#ff7043'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#ff5722'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#f4511e'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#e64a19'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#d84315'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#bf360c'),
							new __Text('a100', "'"),
							__ColorRGBA.fromHex('#ff9e80'),
							new __Text('a200', "'"),
							__ColorRGBA.fromHex('#ff6e40'),
							new __Text('a400', "'"),
							__ColorRGBA.fromHex('#ff3d00'),
							new __Text('a700', "'"),
							__ColorRGBA.fromHex('#dd2c00'),
						]),
						new __Text('brown', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#efebe9'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#d7ccc8'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#bcaaa4'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#a1887f'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#8d6e63'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#795548'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#6d4c41'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#5d4037'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#4e342e'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#3e2723'),
						]),
						new __Text('grey', "'"),
						new __Map([
							new __Text('50', "'"),
							...
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#eeeeee'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#e0e0e0'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#bdbdbd'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#9e9e9e'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#757575'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#616161'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#424242'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#212121'),
						]),
						new __Text('blue-grey', "'"),
						new __Map([
							new __Text('50', "'"),
							__ColorRGBA.fromHex('#eceff1'),
							new __Text('100', "'"),
							__ColorRGBA.fromHex('#cfd8dc'),
							new __Text('200', "'"),
							__ColorRGBA.fromHex('#b0bec5'),
							new __Text('300', "'"),
							__ColorRGBA.fromHex('#90a4ae'),
							new __Text('400', "'"),
							__ColorRGBA.fromHex('#78909c'),
							new __Text('500', "'"),
							__ColorRGBA.fromHex('#607d8b'),
							new __Text('600', "'"),
							__ColorRGBA.fromHex('#546e7a'),
							new __Text('700', "'"),
							__ColorRGBA.fromHex('#455a64'),
							new __Text('800', "'"),
							__ColorRGBA.fromHex('#37474f'),
							new __Text('900', "'"),
							__ColorRGBA.fromHex('#263238'),
							new __Text('1000', "'"),
							__ColorRGBA.fromHex('#11171a'),
						]),
					]),
				2,
			);
			__rt_setDynamic(
				'$base-color',
				__rt_getGlobalDefault('$base_color') ||
					__rt_box(
						(
							__rt_functions.material_color || material_color__fn
						).apply(
							__rt.functions,
							__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$base_highlight_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
							__rt.functions,
							__rt_applySpreadArgs([
								__rt_get('$base_color_name'),
			...
			__rt_setDynamic(
				'$base-light-color',
				__rt_getGlobalDefault('$base_light_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				'$base-dark-color',
				__rt_getGlobalDefault('$base_dark_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				'$base-pressed-color',
				__rt_getGlobalDefault('$base_pressed_color') ||
					__rt_box(
						__rt_registered.darken.apply(
							__rt.registered,
							__rt_applySpreadArgs([
								__rt_test(__rt_get('$dark_mode'))
									? __rt_box(
											__rt.registered.darken.apply(
												__rt.registered,
												__rt_applySpreadArgs([
													__rt_get('$base_color'),
													new __Numeric(15, '%'),
			...
			__rt_setDynamic(
				'$base-focused-color',
				__rt_getGlobalDefault('$base_focused_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$base_invisible_color') ||
					__rt_box(
						__rt.registered.rgba.apply(
							__rt.registered,
							__rt_applySpreadArgs([
								__rt_get('$base_color'),
								new __Numeric(0),
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$material_foreground_colors') ||
					new __Map([
						new __Text('red', "'"),
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$base_foreground_color') ||
					__rt_box(
						(
							__rt.functions.material_foreground_color ||
							material_foreground_color__fn
						).apply(
							__rt.functions,
							__rt_applySpreadArgs([
								__rt_get('$base_color_name'),
			...
			__rt_setDynamic(
				'$accent_color_name',
				__rt_getGlobalDefault('$accent_color_name') ||
					new __Text('grey', "'"),
				12,
			);
			__rt_setDynamic(
				'$accent-color',
				__rt_getGlobalDefault('$accent_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				'$accent-light-color',
				__rt_getGlobalDefault('$accent_light_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				'$accent-dark-color',
				__rt_getGlobalDefault('$accent_dark_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$accent_pressed_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_box(
								__rt.registered.darken.apply(
									__rt.registered,
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$accent_invisible_color') ||
					__rt_box(
						__rt.registered.rgba.apply(
							__rt.registered,
							__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$accent_foreground_color') ||
					__rt_box(
						(
							__rt.functions.material_foreground_color ||
							material_foreground_color__fn
			...
			__rt_setDynamic(
				'$confirm-color',
				__rt_getGlobalDefault('$confirm_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$confirm_pressed_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_box(
								__rt.registered.darken.apply(
									__rt.registered,
			...
			__rt_setDynamic(
				'$alert-color',
				__rt_getGlobalDefault('$alert_color') ||
					__rt_box(
						(
							__rt.functions.material_color || material_color__fn
						).apply(
			...
			__rt_setDynamic(
				'$alert-pressed-color',
				__rt_getGlobalDefault('$alert_pressed_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_box(
								__rt.registered.darken.apply(
									__rt.registered,
			...
			__rt_setDynamic(
				__strings._,
				__rt_getGlobalDefault(__strings._) ||
					(__rt_test(__rt_get('$dark_mode'))
						? __ColorRGBA.fromHex('#ffffff')
						: __ColorRGBA.fromHex('#111111')),
				23,
			);
			__rt_setDynamic(
				'$reverse-color',
				__rt_getGlobalDefault('$reverse_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __ColorRGBA.fromHex('#222')
						: __ColorRGBA.fromHex('#fff')),
				24,
			...
			__rt_setDynamic(
				'$highlight-color',
				__rt_getGlobalDefault('$highlight_color') ||
					__rt_box(
						__rt.registered.rgba.apply(
							__rt.registered,
							__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				'$disabled-color',
				__rt_getGlobalDefault('$disabled_color') ||
					__rt_box(
						__rt.registered.rgba.apply(
							__rt.registered,
							__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$reverse_disabled_color') ||
					__rt_box(
						__rt.registered.rgba.apply(
							__rt.registered,
							__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				'$divider-color',
				__rt_getGlobalDefault('$divider_color') ||
					__rt_box(
						__rt.registered.mix.apply(
							__rt.registered,
							__rt_applySpreadArgs([
								__rt_get(__strings._),
								__rt_get('$reverse_color'),
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$selected_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_get('$base_dark_color')
						: __rt_box(
								(
									__rt.functions.material_color ||
									material_color__fn
								).apply(
									__rt.functions,
									__rt_applySpreadArgs([
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$hovered_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$header_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_box(
								(
									__rt.functions.material_color ||
			...
			__rt_setDynamic(
				'$faded-color',
				__rt_getGlobalDefault('$faded_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __ColorRGBA.fromHex('#4d4d4d')
						: __ColorRGBA.fromHex('#e1e1e1')),
				32,
			);
			__rt_setDynamic(
				'$background-color',
				__rt_getGlobalDefault('$background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$alt_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$reverse_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __ColorRGBA.fromHex('#fafafa')
						: __ColorRGBA.fromHex('#303030')),
				35,
			...
			__rt_setDynamic(
				...
				__rt_getGlobalDefault('$reverse_alt_background_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __ColorRGBA.fromHex('#f5f5f5')
						: __ColorRGBA.fromHex('#3a3a3a')),
				36,
			...
			__rt_setDynamic(
				'$overlay-color',
				__rt_getGlobalDefault('$overlay_color') ||
					(__rt_test(__rt_get('$dark_mode'))
						? __rt_box(
								__rt.registered.rgba.apply(
									__rt.registered,
			...
			__rt_setDynamic(
				'$content-padding',
				__rt_getGlobalDefault('$content_padding') ||
					new __Numeric(16, 'px'),
				38,
			);
		},
		{
			...
			html: ['base_color_name', 'accent_color_name'],
		},
	);
})(Fashion);
